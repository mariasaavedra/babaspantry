...
export interface AnimatedButtonProps extends MaybeParentComponentProps {}

export default function AnimatedButton(props: AnimatedButtonProps) {
  return (
    <div className={styles.AnimatedButtonComponent}>
      <span>{props?.children}</span>
      <div className="animate__animated spin">
        <svg
          className="animate__animated spin"
          id="Layer_2"
          data-name="Layer 2"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 105.45 107.52"
        >
